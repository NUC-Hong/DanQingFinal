...
Page({
  data:{
    ...
    img2:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/donglian3.mp4",//表示变换后的视频展示
    img3:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/donglian1.jpeg",//表示变换前上传的图片
  ...
  game(){
    ...
    wx.showLoading({//加载动画
     ...
     wx.request({//发出请求
      url:'https://www.guhua.online/motion',
       method:'post',
       data:{
