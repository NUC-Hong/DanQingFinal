...
Page({
  data:{
    isExamine: "false",
    img1:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/vidioClear1.mp4",//变换前上传视频
    img2:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/vidioClear2.mp4",//表示变换后的视频展示
  ...
  game(){
    ...
    wx.showLoading({//加载动画
     ...
     wx.request({//发出请求
      url:'https://www.guhua.online/part1/videoClear',
       method:'post',
       data:{
