...
Page({
  data:{
    img1:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/change1.png",//变换前的
    img2:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/change2.png"//表示变换后的图像展示
  ...
  game(){
    ...
    wx.showLoading({//加载动画
     ...
     wx.request({//发出请求
        url:'https://www.guhua.online/changeSize',
       method:'post',
       data:{
  ...
  game2(){
    ...
    wx.showLoading({//加载动画
     ...
     wx.request({//发出请求
      url:'https://www.guhua.online/big',
       method:'post',
       data:{
         x:getPathimg1(that.data.img1),
       },
