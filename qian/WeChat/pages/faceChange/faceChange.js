...
Page({
  data:{
    isExamine: "false",
    img1:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/facechange1.jpg",//变换前的
    img2:"https://guhua-buc-1324634892.cos.ap-shanghai.myqcloud.com/static1/facechange2.jpeg",//表示变换后的图像展示
  ...
  game(){
    ...
    wx.showLoading({//加载动画
     ...
     wx.request({//发出请求
      url:'https://www.guhua.online/faceChange',
       method:'post',
       data:{
