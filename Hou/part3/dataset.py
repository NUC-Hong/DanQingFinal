...
def load_img():
    ...
    class MyDataset(Dataset):
        def __init__(self, img_path, transform):
            ...
            self.root = 'D:/shenzhen/data10001-jpg/list/'+img_path
            f = open(self.root, 'r')
            ...
            for line in data: #这里的line是每个图片的名字
                imgA.append('D:/shenzhen/data10001-jpg/train/A/'+line)
                imgB.append('D:/shenzhen/data10001-jpg/train/B/'+line)
                label.append('D:/shenzhen/data10001-jpg/train/label/'+line)
            self.imgA = imgA
            self.imgB = imgB
            self.label = label
